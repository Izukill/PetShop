...
export class CreateServicoDto {
  @ApiProperty({
    ...
    enum: ServicoStatus,
    example: ServicoStatus.AGENDADO,
  })
  @IsNotEmpty({ message: 'O status é obrigatório.' })
  @IsEnum(ServicoStatus, {
    message: 'Status inválido. Use AGENDADO, ANDAMENTO, CONCLUIDO ou CANCELADO',
  })
  status!: ServicoStatus;

  @ApiProperty({
    description: 'Observação do serviço',
    example: 'O pet precisa de atenção especial durante o banho.',
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Data de agendamento do serviço',
  ...
  @ApiProperty({ description: 'Preço unitário do serviço', example: 150.0 })
  @IsNotEmpty({ message: 'O preço unitário é obrigatório.' })
  @IsDecimal()
  precoUnitario!: string;

  @ApiProperty({
    description: 'lookupId do tipo de serviço associado ao serviço',
    example: 1,
  })
  @IsNotEmpty({ message: 'O tipo de serviço é obrigatório.' })
  @IsInt({
    message: 'O lookupId do tipo de serviço deve ser um número inteiro',
  })
  tipoServicolookupId!: string;

  @ApiProperty({
    description: 'lookupId do pet associado ao serviço',
    example: 1,
  })
  ...
  @ApiProperty({
    description: 'lookupId do funcionário associado ao serviço',
    example: 1,
  })
  ...
  @ApiProperty({
    description: 'lookupId da venda associada ao serviço',
    example: 1,
    required: false,
  })
  @IsOptional()
