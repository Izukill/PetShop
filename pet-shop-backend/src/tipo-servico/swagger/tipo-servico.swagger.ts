...
export function ApiDocCriarTipoServico() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Cria uma nova categoria de serviço que o PetShop oferece (ex: Banho e Tosa, Corte de Unhas) definindo nome e preço padrão.',
    }),
    ApiResponse({
      status: 201,
    ...
    ApiResponse({
      status: 400,
      description:
        'Dados de entrada inválidos (ex: preço negativo ou nome vazio).',
    }),
  );
}
...
export function ApiDocListarTiposServico() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Retorna todos os tipos de serviços ativos disponíveis para serem vendidos no balcão.',
    }),
    ApiResponse({
      status: 200,
...
export function ApiDocBuscarTipoServicoPorId() {
  return applyDecorators(
    ...
    ApiParam({
      name: 'lookupId',
      description: 'lookupId numérico do tipo de serviço',
      example: '345fgdQ@#$df',
    }),
    ApiResponse({
      status: 200,
    ...
    ApiResponse({
      status: 404,
      description: 'Serviço não encontrado no banco de dados.',
    }),
  );
}
...
export function ApiDocAtualizarTipoServico() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Permite alterar informações de um serviço existente, como reajustar o preço ou mudar a descrição.',
    }),
    ApiParam({
      name: 'lookupId',
      description: 'lookupId numérico do tipo de serviço a ser atualizado',
      example: '345fgdQ@#$df',
    }),
    ApiResponse({
      status: 200,
...
export function ApiDocRemoverTipoServico() {
  return applyDecorators(
    ApiOperation({
      ...
      description:
        'Exclui ou desativa um serviço para que ele não apareça mais nas novas vendas.',
    }),
    ApiParam({
      name: 'lookupId',
      description: 'lookupId numérico do tipo de serviço a ser removido',
      example: '345fgdQ@#$df',
    }),
